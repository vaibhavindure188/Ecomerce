...
const singleFilters = [
    {
        ...
        options: [
          ...
          { value: '500-100', label: '500-1000', checked: false },
          { value: '1000-2000', label: '1000-2000', checked: false },
          { value: '2000-3000', label: '2000-3000', checked: false },
          { value: '3000-And-Bbove', label: '3000-And-Bbove', checked: false },
        ],
      },
      {
        id: 'Discount',
      ...
      },
      {
        ...
        name: 'Availability',
        options: [
          { value: 'In-Stock', label: 'Instock', checked: false },
          { value: 'OutOff the Stock', label: 'Out Off the Stock', checked: false },
...
const handlePaginationChange = (e, value) =>{
 ...
 useEffect(()=>{
  ...
  const handleFilters = (value, sectionId) =>{
    ...
    if(filterValue.length > 0){
      searchParams.set(sectionId ,filterValue.join("_"))
    }
